document.addEventListener("DOMContentLoaded", function() {
  ...
  const projectsData = [
    {
      ...
      detailsHtml: '<h2>Khanmigo 深度剖析</h2><div class="project-category">教育产品分析</div><p style="color: var(--text-secondary); margin-bottom: 30px; font-size: 18px; line-height: 1.6;">基于原创评估框架，对 Khanmigo 的交互、教学法、产品策略进行系统化分析。</p><h3>核心要点</h3><ul><li>苏格拉底式引导</li><li>提示词工程结构化</li><li>学习路径设计</li></ul><div class="modal-actions"><a class="btn btn-primary" href="thought/khanmigo_review.html">进入项目</a></div>'
    },
    {
      id: 'socrates-details',
      title: '苏格拉底机器人',
      ...
      tags: ['LLM','交互设计','教学引导'],
      detailsHtml: '<h2>苏格拉底机器人</h2><div class="project-category">交互式机器人</div><p style="color: var(--text-secondary); margin-bottom: 30px; font-size: 18px; line-height: 1.6;">与“苏格拉底”进行思维对话，拒绝直接给答案，强调启发与质询。</p><h3>交互原则</h3><ul><li>不直接给答案</li><li>递进式提问</li><li>反思与总结</li></ul><div class="modal-actions"><a class="btn btn-primary" href="practice/index.html">进入项目</a></div>'
    },
    {
      ...
      tags: ['课程设计','前端工具','教育产品'],
      detailsHtml: '<h2>智能课程架构师</h2><div class="project-category">课程工具</div><p style="color: var(--text-secondary); margin-bottom: 30px; font-size: 18px; line-height: 1.6;">输入主题自动生成课程大纲，支持层级结构与导出。</p><h3>能力点</h3><ul><li>主题解析</li><li>章节生成</li><li>导出优化</li></ul><div class="modal-actions"><a class="btn btn-primary" href="vision/index.html">进入项目</a></div>'
    }
  ];
  ...
  if (!prefersReducedMotion) {
    ...
    function startHero() {
      ...
      tl.to(".main-title", { opacity: 1, y: 0, duration: 1 })
        .fromTo(".tag-word", { y: '100%', opacity: 0 }, { y: '0%', opacity: 1, duration: 0.6, stagger: 0.05 }, "-=0.4")
        .to(".highlight-item", { opacity: 1, y: 0, stagger: 0.12, duration: 0.8 }, "-=0.2");
    }
    ...
    gsap.utils.toArray('.gsap-reveal-scale').forEach(elem => {
      gsap.fromTo(elem, { opacity: 0, scale: 0.9 }, {
        opacity: 1,
        scale: 1,
        duration: 1.2,
        ease: "power3.out",
  ...
  window.showModal = function(targetId) {
    ...
    if (!prefersReducedMotion) {
      ...
      tl.fromTo('.modal-overlay', { opacity: 0 }, { opacity: 1, duration: 0.2, ease: 'power1.out' })
        .fromTo('.modal-content', { y: 60, scale: 0.9, opacity: 0 }, { y: 0, scale: 1, opacity: 1, duration: 0.5, ease: 'back.out(1.4)' }, '<');
    }
  ...
  function hideModal() {
    if (!prefersReducedMotion) {
      gsap.to('.modal-content', { y: 40, scale: 0.95, opacity: 0, duration: 0.25, ease: 'back.in(1.2)', onComplete: () => { modalOverlay.classList.remove('is-active'); bodyEl.classList.remove('modal-open'); } });
    } else {
