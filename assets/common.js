(function(){
  document.addEventListener('DOMContentLoaded', function(){
    ...
    document.querySelectorAll('.navbar a').forEach(function(a){
      var href = a.getAttribute('href') || '';
      if (href === '/vision/index.html' || href === 'vision/index.html' || href === 'https://www.anjianzhao.online/vision/index.html') {
        a.setAttribute('href', 'https://www.anjianzhao.online/vision/portfolio/projects/course-gen/index.html');
